...
s2 = create_sprite("Butterfly (1).gif", -100, 100)
s3 = create_sprite("cardinal", -100, -100)
s4 = create_sprite("cardinal", 100, -100)

message1 = create_sprite("alien",-200,200)
message1.color("red")
message1.write("Julia Nelson",font = ("Arial", 30, "normal"))
message1.hideturtle()

message2 = create_sprite("alien",-200,-250)
message2.color("black")
message2.write("Be the change you wish to see in the world",font = ("Arial", 40, "normal"))
message2.hideturtle()
